...
public class DynCalculator {
     ...
     */
    private Operation getOperation(String operationString) throws IOException, UnknownOperationException, ClassNotFoundException, InstantiationException, IllegalAccessException {
